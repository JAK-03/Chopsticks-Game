...
class Player:
    def __init__(self, name, num_of_hands, total_num_of_fingers, player_num, fingers):
        ...
        for i in range(num_of_hands):
            if i + 1 == 1:
                self.my_hands.append(Hand(name + "'s " + str(i+1) + "st hand", total_num_of_fingers, fingers[i]))
            elif i + 1 == 2:
                self.my_hands.append(Hand(name + "'s " + str(i+1) + "nd hand", total_num_of_fingers, fingers[i]))
            elif i + 1 == 3:
                self.my_hands.append(Hand(name + "'s " + str(i+1) + "rd hand", total_num_of_fingers, fingers[i]))
            else:
                self.my_hands.append(Hand(name + "'s " + str(i+1) + "th hand", total_num_of_fingers, fingers[i]))
...
class Player:
    def __init__(self, name, num_of_hands, total_num_of_fingers, player_num):
        self.name = name
        self.num_of_hands = num_of_hands
        self.my_hands = []
        for i in range(num_of_hands):
            if i + 1 == 1:
                self.my_hands.append(Hand(name + "'s " + str(i+1) + "st hand", total_num_of_fingers, 1))
            elif i + 1 == 2:
                self.my_hands.append(Hand(name + "'s " + str(i+1) + "nd hand", total_num_of_fingers, 1))
            elif i + 1 == 3:
                self.my_hands.append(Hand(name + "'s " + str(i+1) + "rd hand", total_num_of_fingers, 1))
            else:
                self.my_hands.append(Hand(name + "'s " + str(i+1) + "th hand", total_num_of_fingers, 1))
        self.player_num = player_num
